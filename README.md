...
* [NA] Download server dependencies by running `npm install`
* [NA] Run the local web server by running `node server.js`
* [NA] Open a new terminal window and cd into the client code `cd client`
